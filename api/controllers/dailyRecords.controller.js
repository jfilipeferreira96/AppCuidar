...
exports.create = (req, res) => {
  ...
  new DailyRecords({
    ...
    mealDinner: req.body.mealDinner,
    ...
    atvInsCasa: req.body.atvInsCasa,
    atvInsComunicacao: req.body.atvInsComunicacao,
    atvInsCompras: req.body.atvInsCompras,
    atvInsPrepAlimento: req.body.atvInsPrepAlimento,
    atvInsRoupas: req.body.atvInsRoupas,
    atvInstLocomocao: req.body.atvInstLocomocao,
    atvInstAdmMedicamento: req.body.atvInstAdmMedicamento,
    atvInstFinancas: req.body.atvInstFinancas,
